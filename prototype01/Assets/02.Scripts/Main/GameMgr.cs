...
public class GameMgr : MonoBehaviour
{
    ...
    public void ItemMake()
    {
        ...
        //if (balloonFlag.IsFlagged() == true) { rndLimit = 100; }
        //else { rndLimit = 40; }
    ...
    public void BalloonMake()
    {
        ...
        if (balloonFlag.GetCnt() == 1) { rndlimit = 2; }
        else if (balloonFlag.GetCnt() == 2) { rndlimit = 3; }
        else if (balloonFlag.GetCnt() == 3) { rndlimit = 4; }
    ...
    {
        // 움직여야 할 위치
        Vector3 movPos = new Vector3(0f, cam.transform.position.y, -6f);
